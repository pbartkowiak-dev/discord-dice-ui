...
export default {
	...
	assistanceInfo: <span>This will be used mostly by DM when using <strong>Groups</strong>. Adds additional d20s to the roll.</span>,
	...
	coCModTooltip: <span>Will open modal with additional options on the <strong>d100</strong> roll.</span>,
	warhammerTooltip: <span>Supports rolling <strong>SL</strong> for Warhammer 4e and <strong>DoS</strong> for Dark Heresy II.</span>,
	conanTooltip: <span>Supports <strong>d20 Conan Dice</strong> and <strong>d6 Combat Dice</strong>.</span>,
