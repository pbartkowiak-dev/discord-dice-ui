    ...
    <Table className={styles.successLevelLadder} bordered>
      <tbody>
        ...
        <tr>
          <td
            className={
              successLevels.isExtremeSuccess
        ...
        <tr>
          <td
            className={
              successLevels.isRegularSuccess
                ? styles.successActive
                : styles.cellInactive
            }
          >
        ...
        <tr>
          <td
            className={
              successLevels.isRegularFailure
                ? styles.failureActive
                : styles.cellInactive
            }
          >
            <div className={styles.cellContainer}>
