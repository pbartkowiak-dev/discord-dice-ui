...
export const getDiscordMsgData = ({ isAnonymous }: Props): ReturnType => {
	...
	let description = '> When we use this card, we simply edit out anything X-Carded. And if there is ever an issue, anyone can call for a break and we can talk privately.'
