...
import cthulhuAttributesList, {
  AttributeType,
} from "./utils/cthulhuAttributesList";
...
function CthulhuSheetModal() {
  ...
  const updateAttributes = (st: any) =>
    dispatch(cthulhuAttributesUpdateRequested(st));
  ...
  return (
    <Modal show={showCthulhuSheetModal} onHide={hideModal} size="lg">
      <Modal.Header closeButton>
        <Modal.Title>
          <FontAwesomeIcon className={styles.headerIcon} icon={faFileInvoice} />{" "}
          Character Sheet
        </Modal.Title>
      </Modal.Header>
      <Modal.Body>
      ...
      <Modal.Footer>
        ...
        <Button variant="success" onClick={saveChanges} type="submit">
          Save changes
        </Button>
      </Modal.Footer>
    </Modal>
