...
function ResultsTable() {
  ...
  const resultsSorted = [...results].sort(
    (a: Result, b: Result) => b.val - a.val
  );
  ...
  return (
    <div className={styles.resultsTable}>
      {exaltedIcons > 0 && (
        <span className={styles.exaltedExclamation}>Exalted!</span>
      )}
      <div className={styles.resultsTableWrapper}>
        ...
        {normalIcons > 0 && normalIcons + exaltedIcons < results.length && (
