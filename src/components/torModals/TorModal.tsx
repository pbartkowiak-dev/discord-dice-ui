...
export default () => {
  ...
  const isValid = () => {
    ...
    if (
      isNaN(successDiceAmountNumber) ||
      successDiceAmountNumber < 0 ||
      successDiceAmountNumber > successDiceAmountMax
    ) {
      isValid = false;
    }
  ...
  const onChange = (type: "successDie" | "modifier", event: any) => {
    ...
    if (type === "modifier") {
      if (
        isValueValid(event.target.value) &&
        value <= modifierMax &&
        value >= modifierMin
      ) {
        setModifier(`${value}`);
        ...
        <section className={torStyles.favouredRollSection}>
          <div className={torStyles.checkboxContainer}>
            <Form.Check
              ...
              label={
                <div>
                  <span>Favoured Roll</span> <FavouredTooltip />
                </div>
              }
              checked={isFavoured}
            ...
            <Form.Check
              ...
              label={
                <div>
                  <span>Ill-Favoured Roll</span> <IllFavouredTooltip />
                </div>
              }
        ...
        <section>
          <h5
            className={classNames(
              torStyles.subheader,
              torStyles.subheader__split
            )}
          >
            <span>Success Dice Number</span>
            <span>/</span>
            <span>Modifier</span>
          </h5>
          <div className={torStyles.poolBuilder}>
            ...
            <div
              className={classNames(
                torStyles.poolBuilderCol,
                torStyles.poolBuilderIcon
              )}
            >
        ...
        <section>
          ...
          <div className={torStyles.checkboxContainer}>
            ...
            <Form.Check
              ...
              label={
                <div>
                  <span>Miserable</span> <MiserableTooltip />
                </div>
              }
              checked={isMiserable}
