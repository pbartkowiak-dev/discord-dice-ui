...
import InfinityDiceRow from './InfinityDiceRow';
...
// @ts-ignore
const createRenderer = render => ({ input, label, id, textMuted, meta, disabled, placeholder }, ...rest) => {
	return (
		<>
...
// @ts-ignore
const renderInput = createRenderer((input, label, id, textMuted, meta, disabled, placeholder) => {
...
function InfinityModalForm({
	...
	const assistanceFocusLabel = <span>Foc <InfoTooltip placement="bottom" content={tooltip.assistanceFocusInfo} /></span>;
	const assistanceTnLabel = <span>TN <InfoTooltip placement="bottom" content={tooltip.assistanceFocusInfo} /></span>;
