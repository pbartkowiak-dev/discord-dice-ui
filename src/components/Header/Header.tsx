...
function Header({
  ...
  return (
    <Navbar variant="light">
      <Navbar.Brand>
        <img src={logo} className="logo align-top" alt="RPG Poznań Logo" />
        <img
          src={logoSmall}
      ...
      <a href={GITHUB_PAGE}>
        <TooltipWrapper content="Go to Github Repo" placement="left">
          <FontAwesomeIcon className="pointer icon-settings" icon={faGithub} />
        </TooltipWrapper>
      </a>
            ...
            <>
              ...
              {!username && (
                <div className="settings-text-danger">
                  <FontAwesomeIcon icon={faExclamationCircle} /> Username is
                  missing
                </div>
              )}
              {!hookUrl && (
                <div className="settings-text-danger">
                  <FontAwesomeIcon icon={faExclamationCircle} /> Discord's hook
                  url is missing
                </div>
              )}
            </>
